...
function applySiteAnimations() {
  document.querySelector("h1").classList.add("animation-h1");

  document.querySelector("h2").classList.add("animation-h2");

  const elementsH3 = document.querySelectorAll("h3");

  elementsH3.forEach((element) => {
    element.classList.add("animation-h3");
  });

  const elementsImg = document.querySelectorAll("img");

  elementsImg.forEach((elementImg) => {
    elementImg.classList.add("fade-in");
  });
}
